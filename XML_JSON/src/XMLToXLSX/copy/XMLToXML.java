...
public class XMLToXML {
	...
	public static void XMLToXML_Convert(String inputPath, String output_xml, String output_excel) throws ParserConfigurationException, SAXException, IOException {
		...
		while (line != null) {
			try {
				...
				if (first_tagname.equalsIgnoreCase(last_tagname)) {
					...
					line = "<" + last_tagname_temp + ">" + "%%" + last_tagname + "%%" + "</" + last_tagname_temp + ">";
